...
/* nestedFunction can access the variable "internal" because of closure. Nested variables are able to reach outside of them to grab data. */
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce(function(total, accumulator){
      return total += accumulator.population
    },0)
    return totalPop
  }
